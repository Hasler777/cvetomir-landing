...
const items = [
  { i: "01", t: "Формат магазина под ваш город", d: "Поможем выбрать подходящий формат точки, оценить локацию и понять, где магазину будет проще получать клиентов." },
  { i: "02", t: "Понятный план открытия", d: "Запускаемся по отработанной методике — шаг за шагом и под чутким контролем." },
  ...
  { i: "05", t: "Обучение для вас и команды", d: "Простым языком объясним, как устроен цветочный бизнес, и расскажем секретные приёмы, собранные за 14 лет практики." },
...
export default function WhatsIncluded() {
  return (
    <section id="included" className="relative overflow-hidden bg-white py-20 md:py-28">
      <BigFlower variant="a" className="absolute right-8 top-12 hidden h-[190px] w-[190px] opacity-90 lg:block" />
      <BigFlower variant="c" className="absolute right-56 top-28 hidden h-[120px] w-[120px] opacity-80 xl:block" />
