...
export default function Founder() {
  return (
    <section
      id="founder"
      className="seam-soft relative overflow-hidden bg-brand-green py-20 text-white md:py-28"
    >
      ...
      <div className="container-x relative grid items-center gap-12 lg:grid-cols-[1fr_1.2fr]">
        <div className="order-2 lg:order-1">
          ...
          <blockquote className="mt-8 rounded-card border-l-4 border-brand-yellow bg-white/15 p-6 backdrop-blur">
