...
export default function Trust() {
  return (
    <section className="relative overflow-hidden bg-brand-green py-20 text-white md:py-28">
      <BigFlower variant="a" className="absolute right-6 top-8 hidden h-[120px] w-[120px] opacity-90 lg:block" />
      ...
      <div className="container-x relative">
        ...
        <ul className="mt-12 grid grid-cols-1 gap-5 sm:auto-rows-fr sm:grid-cols-2">
          {stats.map((s) => (
            <li
              key={s.accent}
              className="h-full rounded-card bg-white p-6 shadow-card md:p-7"
            >
